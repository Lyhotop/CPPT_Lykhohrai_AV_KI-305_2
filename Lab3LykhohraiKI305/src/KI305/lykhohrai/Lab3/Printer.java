...
public abstract class Printer{
    ...
    public Printer(InkCartridge inkCartridge, PaperTray paperTray, NetworkConnection networkConnection) {
        model = "unknow";
        resourse = 0;
    ...
    public void powerOn() {
        ...
        if (resourse == 0)
            ...
            System.out.print("Пристрій ввімкнено!\n");
            work = true;
            resourse--;
        }
    }
    ...
    void SetPrinterResource(int res) {
        writeLogs("Set printer recourse.\n");
        resourse = res;
    }
    // Set printer name.
    ...
    int GetInk(){
        return inkCartridge.GetInkLevel();
    }
